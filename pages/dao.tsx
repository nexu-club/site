...
export default function Dao() {
  return (
    <div className='flex flex-col items-center justify-center min-h-screen '>
        ...
        <div className='border-white rounded-3xl border-2 p-8 w-full lg:max-w-md mb-24 text-2xl'>
          <p>Una <strong>DAO</strong>, u <strong>Organización Autónoma Descentralizada</strong>, es una entidad directiva sin intermediarios que opera en la <i>blockchain</i>. Funciona a través de un conjunto de contratos inteligentes autoejecutables que definen las reglas y decisiones de la organización, permitiendo a los miembros participar en la toma de decisiones mediante votación ponderada por la cantidad de tokens que poseen. La transparencia y la inmutabilidad inherentes a la tecnología blockchain garantizan la integridad de las reglas acordadas, brindando a los miembros un control directo sobre los recursos y objetivos de la <strong>DAO</strong>.</p>
          <br/>
          ...
          <p><Link href="https://optimistic.etherscan.io/address/0x0caa49278724ad64c635dc1249dc4b38869f83b1" className='underline'>Contrato DAO</Link></p>
          <p>Fecha de creación: 8 NOV 2023</p>
          <p>Red: <Link href="https://optimism.io" target='_blank' className='underline'>Optimism</Link></p>
